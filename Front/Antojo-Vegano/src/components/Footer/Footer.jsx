    ...
    return(<>
        <footer className="container-footer">
            ...
            <div className="footer-content">
                <section className="container-navegation">
                    <div className="title-footer">
                        <img src={logo} alt="Imagen Logo Antojo Vegano" /> 
                        <span>Antojo Vegano</span>
                    </div>
                    <a className=""  href="#">Sobre Nosotros</a>
                    <a className="" href="#">Contacto</a>
                    <a className="" href="/productos">Nuestros Productos</a>
                </section>
            ...
            <section className="container-media">
                <p> 💖✨No te olvides de seguinos en instagram, siempre estamos subiendo contenido y pormociones ✨💖 </p>
                {/* Redes Sociales */}
